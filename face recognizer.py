...
while True:
    ...
    if face_extractor(frame) is not None:
        ...
        #path
        file_name_path = 'My_Image_Dataset/' + str(count) + '.jpg'
...
model.train(np.asarray(Training_Data_1), np.asarray(Labels_1))
...
while True:
    ...
    try:
        ...
        if confidence > 70:
            cv2.putText(image, "Hello bud!!", (250, 450), cv2.FONT_HERSHEY_COMPLEX, 1, (0,255,0), 2)
